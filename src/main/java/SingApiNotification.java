...
public class SingApiNotification {
    ...
    private final static String TASK_NAME = "SingPlusNotification";

    // kafka
    private final static int    zkPort  = 2181 ;
    private final static String zkId    = "SingAPiNotification";
    private final static String zkHost  = "fr-log";
    private final static String zkRoot  = "";
    private final static String zkTopic = "SingPlusNotification";


    // Hdfs
    private final static int    hdfsPort = 9000;
    private final static int    tupleNum = 1000 ;
    private final static String hdfsHost = "fr-log";
